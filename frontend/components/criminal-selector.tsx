...
export function CriminalSelector({ selectedId, onSelect, search, onSearchChange }: CriminalSelectorProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      {criminals === undefined ? (
        <div className="py-8 text-center text-sm text-muted-foreground">Loading criminals...</div>
      ) : criminals.length === 0 ? (
