...
1. **Project Start**: create context to establish baseline documentation
2. **Session Start**: ask to load current context
3. **Development**: Work on your project with full context awareness
4. **Session End**: update the context files to capture changes and progress
